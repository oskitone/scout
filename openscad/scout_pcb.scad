...
PCB_BUTTON_POSITIONS = [
    _([170.942 + 2.54 * .9, 121.92 - 2.54 * 2.45], [0, 2.54 / -2]),
    _([163.322 + 2.54 * .9, 121.92 - 2.54 * 2.45], [0, 2.54 / -2]),
    _([155.702 + 2.54 * .9, 121.92 - 2.54 * 2.45], [0, 2.54 / -2]),
    _([148.082 + 2.54 * .9, 121.92 - 2.54 * 2.45], [0, 2.54 / -2]),
    _([140.462 + 2.54 * .9, 121.92 - 2.54 * 2.45], [0, 2.54 / -2]),
    _([125.222 + 2.54 * .9, 121.92 - 2.54 * 2.45], [0, 2.54 / -2]),
    _([117.602 + 2.54 * .9, 121.92 - 2.54 * 2.45], [0, 2.54 / -2]),
    _([109.982 + 2.54 * .9, 121.92 - 2.54 * 2.45], [0, 2.54 / -2]),
    _([102.362 + 2.54 * .9, 121.92 - 2.54 * 2.45], [0, 2.54 / -2]),
    _([94.742 + 2.54 * .9, 121.92 - 2.54 * 2.45], [0, 2.54 / -2]),
    _([87.122 + 2.54 * .9, 121.92 - 2.54 * 2.45], [0, 2.54 / -2]),
    _([79.502 + 2.54 * .9, 121.92 - 2.54 * 2.45], [0, 2.54 / -2]),
    _([64.262 + 2.54 * .9, 121.92 - 2.54 * 2.45], [0, 2.54 / -2]),
    _([56.642 + 2.54 * .9, 121.92 - 2.54 * 2.45], [0, 2.54 / -2]),
    _([49.022 + 2.54 * .9, 121.92 - 2.54 * 2.45], [0, 2.54 / -2]),
    _([41.402 + 2.54 * .9, 121.92 - 2.54 * 2.45], [0, 2.54 / -2]),
    _([33.782 + 2.54 * .9, 121.92 - 2.54 * 2.45], [0, 2.54 / -2]),
];

PCB_HOLE_DIAMETER = 3.2;
PCB_HOLE_POSITIONS = [
    _([138.938, 107.696 - 2.9], [0, 2.54 / -2]),
    _([104.648, 107.696 - 2.9], [0, 2.54 / -2]),
    _([173.228, 107.696 - 2.9], [0, 2.54 / -2]),
    _([36.068, 107.696 - 2.9], [0, 2.54 / -2]),
    _([70.358, 107.696 - 2.9], [0, 2.54 / -2]),
];

PCB_RELIEF_HOLE_DIAMETER = 3.5;
PCB_RELIEF_HOLE_POSITIONS = [
    _([135.128, 122.555], [0, 2.54 / 2 + .36]), // MAGIC!
    _([74.168, 122.555], [0, 2.54 / 2 + .36]), // MAGIC!
];

PCB_LED_POSITION = _([156.474, 86.706], [-2.54, 2.54]);
PCB_POT_POSITION = _([172.824, 97.796], [-2.54, 7 + 2.54 / 2 + .36]); // MAGIC!
...
PCB_HEADPHONE_JACK_POSITION = _(
    [138.176, 84.11],
    [HEADPHONE_JACK_WIDTH / -2, HEADPHONE_JACK_LENGTH / -2 - .36] // MAGIC!
);
